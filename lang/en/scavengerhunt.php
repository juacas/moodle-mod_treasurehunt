...
$string['userattemptovercome'] = 'Riddle {$a->number} discovered by {$a->user} on the date: {$a->date}';
$string['userattemptfailed'] = 'Location failed by {$a->user} for riddle {$a->number}on the date: {$a->date}';
