...
$string['riddle_editor'] = 'Description of riddle';
$string['default_road'] = 'Road {$a}';
...
$string['completeactivitybefore'] = 'Complete selected activity before';
$string['completeactivitybefore_help'] = 'The selected activity must be completed before the current riddle is displayed. For the activities of the course to be displayed in the list it must be enabled the completion activity in Moodle\'s configuration, in course\'s configuration and the activity itself.';
...
$string['invalidroad'] = 'Assigned road is not validated';
