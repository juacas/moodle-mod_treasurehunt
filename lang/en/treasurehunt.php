...
$string['customlayername_help'] = 'If you use a custom layer a title is needed to show it in the maps or your users.';
...
$string['custommapminlat_help'] = 'South latitude of the image. Use "." as decimal point. More than -85 degrees.';
$string['custommapminlon'] = 'West longitude';
$string['custommapminlon_help'] = 'West longitude of the image. Use "." as decimal point. More than -180 degrees.';
$string['custommapmaxlat'] = 'North latitude';
$string['custommapmaxlat_help'] = 'North latitude of the image. Use "." as decimal point. Less than 85 degrees.';
$string['custommapmaxlon'] = 'East longitude';
$string['custommapmaxlon_help'] = 'East longitude of the image. Use "." as decimal point. Less than 180 degrees.';
