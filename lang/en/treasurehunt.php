...
$string['error'] = 'Error';
$string['timeexceeded'] = 'You have exceeded the time limit for the activity';
...
$string['overcomeactivitytoend'] = 'Activity to complete overcome';
$string['overcomeactivitytoendarq'] = 'Activity to complete overcome and removed question';
