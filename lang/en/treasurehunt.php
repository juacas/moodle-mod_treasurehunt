...
$string['gameupdatetime_help'] = 'Time interval in seconds between a user\'s game update and another. The larger, less update requests should be made, but more time passes to report a possible change. It must be greater than 0 seconds, but the time will be set by default.';
$string['locktimeediting'] = 'Lock time editing';
$string['locktimeediting_help'] = 'Time in seconds for which a user can edit an instance without renewing the lock. The larger, fewer requests for renewal lock must be made, but more time is locked the edit page once the user has finished. It must be greater than 5 seconds, but the time will be set by default.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new treasure hunt.';
...
$string['usercompletionovercome'] = 'Activity to end successfully completed for riddle {$a->position} on the date: {$a->date}';
...
$string['groupcompletionovercome'] = 'Activity to end successfully completed by {$a->user} for riddle {$a->position} on the date: {$a->date}';
...
$string['noasnwerselected'] = 'You must select an answer';
$string['activitytoendwarning'] = 'You must complete first the activity to solve';
$string['overcomeactivitytoend'] = 'Activity \'<strong>{$a}</strong>\' overcome';
