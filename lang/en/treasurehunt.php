...
$string['grade_explaination_temporary'] = 'Temporal score: {$a->rawscore}-{$a->penalization}%: Yu discovered {$a->nosuccessfulstages} out of {$a->nostages} stages. You penalizes {$a->penalization}% due to {$a->nolocationsfailed} wrong places, and {$a->noanswersfailed} wrong answers.';
