...
$string['userattemptovercome'] = 'Pista {$a->number} descubierta por {$a->user} en la fecha: {$a->date}';
$string['userattemptfailed'] = 'Localización fallida por {$a->user} para la pista {$a->number} en la fecha {$a->date}';
