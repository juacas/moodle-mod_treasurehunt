...
$string['usercompletionovercome'] = 'Actividad a finalizar completada con éxito para la pista {$a->position} en la fecha: {$a->date}';
...
$string['groupcompletionovercome'] = 'Actividad a finalizar completada con éxito por {$a->user} para la pista {$a->position} en la fecha: {$a->date}';
