...
$string['managereturnlinktolockedactivities'] = 'Añadir/eliminar enlaces de retorno';
$string['managereturnlinktolockedactivities_help'] = 'Si está habilitado, cuando se aplique una restricción de actividad desde este formulario, se añadirá un texto con un enlace en el campo de descripción de la actividad, de forma que el usuario pueda volver fácilmente a la actividad de la Caza del Tesoro. También se eliminará este texto si la restricción se elimina desde este formulario.';
...
$string['showboard'] = 'Mostrar el prograso de otros participantes';
$string['showboard_help'] = 'Si está habilitado, los participantes pueden ver el progreso de otros participantes en el juego.';
