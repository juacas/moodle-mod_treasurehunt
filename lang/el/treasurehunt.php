...
100% όταν μία διαδρομή ολοκληρώθηκε και 0% όταν κανένα στάδιο δεν επιλύθηκε .</UL>
...
το κυνήγι λαμβάνουν βαθμό κάτω από 50 ο οποίος υπολογίζεται μόνο από τον αριθμό των σταδίων που επιλύθηκαν.</UL>
...
μόνο από τον αριθμό των σταδίων που επιλύθηκαν.</UL>';
...
$string['historicalattempts'] = 'Ιστορικό προσπαθειών {$a}';
...
$string['timelabelfailed'] = 'Η τοποθεσία απεστάλη στις: ';
$string['timelabelsuccess'] = 'Το στάδιο αποκαλύφθηκε στις: ';
