...
$string['exit'] = 'Sortir de la Chasse';
...
$string['hello'] = 'Hello';
$string['attempthistory'] = 'Historique de {$a}';
$string['history'] = 'Historique';
$string['huntcompleted'] = 'Vous avez déjà terminé cette chasse au trésor';
$string['incorrectanswer'] = 'Réponse incorrect.';
$string['info'] = 'Info';
$string['infovalidatelocation'] = 'Valider l\'emplacement de cette étape';
...
$string['lockedclue'] = 'Indice verrouillé';
$string['lockedaclue'] = 'Vous devez effectuer l\'activité \'<strong>{$a}</strong>\' pour débloquer l\'indice';
...
$string['welcome_play_tour'] = '<span style="font-size: 1.5rem; font-weight: bold">Bienvenue à votre chasse au trésor ! </span><br>Cette carte et les indices vous serviront de guide.';
$string['bigbutton_play_tour'] = 'C\'est votre meilleur ami. <br>Un clic et vous obtenez un <b>défis</b> ou de précieux <b>indices</b>.';
$string['autolocate_tour'] = 'Indiquez votre <b>emplacement actuel</b>.<br>(donnez l\'autorisation d\'utiliser "la localisation" lorsqu\'on vous le demande)';
$string['playerhelp_tour'] = 'Cette visite peut être revue quand vous le souhaitez.';
$string['validatelocation_tour'] = 'Confiant dans l\'emplacement d\'une étape?<br><b>Soumettez votre position</b> et découvrez si vous avez raison.';
$string['lastsuccessfulstage_tour'] = 'Dans ce panel, vous pouvez découvrir votre dernière étape réussie. Il peut s\'agir de l\'étape réussie de votre groupe.';
$string['mapplay_tour'] = 'La <b>carte</b> vous montre toutes vos tentatives!<br>Réussite : <img src="pix/success_mark.png" width="28"/><br>Echec : <img src="pix/failure_mark.png" width="28"/>';
$string['playend_tour'] = '<span style="font-size : 1.5rem ; font-weight : bold">Profitez bien de votre chasse au trésor</span><br>avec vos amis !';
