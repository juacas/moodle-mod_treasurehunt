...
$services = array(
    'scavengerservices' => array(//the name of the web service
        'functions' => array('mod_scavengerhunt_fetch_scavengerhunt', 'mod_scavengerhunt_update_riddles', 'mod_scavengerhunt_delete_riddle', 'mod_scavengerhunt_delete_road', 'mod_scavengerhunt_renew_lock','mod_scavengerhunt_validate_location','mod_scavengerhunt_user_progress'), //web service functions of this service
...
$functions = array(
    ...
    'mod_scavengerhunt_validate_location' => array(//web service function name
        'classname' => 'mod_scavengerhunt_external_validate_location', //class containing the external function
        'methodname' => 'validate_location', //external function name
        'classpath' => 'mod/scavengerhunt/externallib.php', //file containing the class/external function
        'description' => 'Creates new groups.', //human readable description of the web service function
        'type' => 'write', //database rights of the web service function (read, write)
    ),
