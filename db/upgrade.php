...
/**
 * This file keeps track of upgrades to the scavengerhunt module
 *
...
/**
 * Execute scavengerhunt upgrade from the given old version
 *
...
function xmldb_scavengerhunt_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the scavengerhunt
     * iself has been upgraded.
     *
     * For each upgrade block, the file scavengerhunt/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        upgrade_mod_savepoint(true, 2007040100, 'scavengerhunt');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define index course (not unique) to be added to scavengerhunt.
        $table = new xmldb_table('scavengerhunt');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'scavengerhunt');
    }
