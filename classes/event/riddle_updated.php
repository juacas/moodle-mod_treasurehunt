...
class riddle_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventriddleupdated', 'mod_scavengerhunt');
    }

    public function get_description() {
        return "The user with id '$this->userid' has updated the scavengerhunt riddle with id '$this->objectid' for " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'scavengerhunt', 'update riddle',
