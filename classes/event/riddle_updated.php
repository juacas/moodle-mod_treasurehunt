...
class riddle_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the treasurehunt riddle with id '$this->objectid' for " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'treasurehunt', 'update riddle',
