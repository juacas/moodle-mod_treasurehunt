...
/**
 * The mod_treasurehunt road finished event class.
 *
 ...
 *
 */
class hunt_succeded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventhuntsucceded', 'mod_treasurehunt');
    }
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' has finished the treasurehunt '$this->objectid' for " .
