if (function () {
    ...
    b.GeocoderJS = a;
}(), "function" == typeof define && define.amd && define(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require)
    var GeocoderJS = require("../GeocoderJS.js");

if (function (a) {
    "use strict";
    a.ProviderBase = function () {
...
if (function (a) {
    "use strict";
    a.ProviderFactory = function () {
    }, a.ProviderFactory.prototype.createProvider = function (b) {
        "string" == typeof b && (b = {
            provider: b
        });
    ...
    a.ExternalURILoader = function (a) {
        ...
        function e(b, c) {
            ...
            d = e.format(h), f.get(d, function (b) {
                if (200 != b.statusCode)
                    throw "Received HTTP status code " + b.statusCode + " when attempting geocoding request.";
        ...
        function f(a, b) {
            ...
            if (f += h.join("&"), d) {
                ...
                e.onload = function () {
                    if (200 != this.status)
                        return console.log("Received HTTP status code " + this.status + " when attempting geocoding request."),
                                b(null);
                    if (!this.responseText || !this.responseText.length)
                        return console.log("Received empty data when attempting geocoding request."),
                                b(null);
                    var a = !1;
                    try {
    ...
    a.MapquestProvider = function (a, b) {
        ...
        this.externalLoader.executeRequest(a, function (a) {
            ...
            if (a.results[0].locations.length)
                for (var e in a.results[0].locations)
