...
function getnextwebCam() {
  return detectedCameras === null || camera === -1
    ? 0
    : (camera + 1) % detectedCameras.length;
}
function getbackCam() {
